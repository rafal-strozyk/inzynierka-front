<template>
  <button
    ...
    :type="props.type"
    class="cursor-pointer inline-flex w-full items-center justify-center rounded-lg px-5 text-sm font-medium text-white focus:outline-none focus:ring-4 sm:w-auto"
...
import type { ModalCallbackType } from "@/types/modal.ts";
